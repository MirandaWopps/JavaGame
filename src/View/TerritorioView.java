...
public class TerritorioView {
	...
	public void desenha(Graphics2D g2d, Color cor, int qtdExerc) {
		...
		// Define a cor do número de exércitos
		...
		else if (qtdExerc < 100)
			g2d.drawString(Integer.toString(qtdExerc), x_exerc-7, y_exerc+5);
		else
			g2d.drawString(Integer.toString(qtdExerc), x_exerc-10, y_exerc+5);
